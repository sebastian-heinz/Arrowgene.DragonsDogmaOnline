...
public class ScriptedQuest : IQuest
{
    ...
    protected override void InitializeEnemyGroups()
    {
        ...
        foreach (var bossIndex in waterfallBossIndex)
        {
            ...
            AddEnemies(waterfallIndex++, Stage.DragonsNest, GroupId.WaterfallGreatCavern, QuestEnemyPlacementType.Manual, new()
            {
        ...
        {
            level = SelectRandomLevel();
            AddEnemies(hermitsHollowIndex++, Stage.DragonsNest, GroupId.HermitsHollow, QuestEnemyPlacementType.Manual, new()
            {
                CreateRandomDragonKin(level, bossIndex),
                CreateRandomGroundEnemy(level, 3),
                CreateRandomGroundEnemy(level, 4),
        ...
        {
            level = SelectRandomLevel();
            AddEnemies(wavingCaveIndex++, Stage.DragonsNest, GroupId.GateOfTheWavingCave, QuestEnemyPlacementType.Manual, new()
            {
                CreateRandomDragonKin(level, bossIndex),
                CreateRandomGroundEnemy(level, 3),
                CreateRandomGroundEnemy(level, 4),
        ...
        AddEnemies(EnemyGroupId.TimeBonus, Stage.DragonsNest, 9, QuestEnemyPlacementType.Manual, new()
        {
        ...
        AddEnemies(EnemyGroupId.DungeonTrash + 0, Stage.DragonsNest, 4, QuestEnemyPlacementType.Manual, new()
        {
        ...
        AddEnemies(EnemyGroupId.DungeonTrash + 1, Stage.DragonsNest, 6, QuestEnemyPlacementType.Manual, new()
        {
        ...
        AddEnemies(EnemyGroupId.DungeonTrash + 2, Stage.DragonsNest, 7, QuestEnemyPlacementType.Manual, new()
        {
        ...
        AddEnemies(EnemyGroupId.DungeonTrash + 3, Stage.DragonsNest, 8, QuestEnemyPlacementType.Manual, new()
        {
        ...
        AddEnemies(EnemyGroupId.DungeonTrash + 4, Stage.DragonsNest, 10, QuestEnemyPlacementType.Manual, new()
        {
    ...
    protected override void InitializeBlocks()
    {
        ...
        process0.AddIsGatherPartyInStageBlock(QuestAnnounceType.None, Stage.DragonsNest)
            .AddEndContentsPurpose(Purpose.DefeatDragonKin);
        ...
        process0.AddDestroyGroupBlock(QuestAnnounceType.None, EnemyGroupId.HermitsHollow + 3, false)
            .AddGeneralAnnounce(QuestGeneralAnnounceType.CommonMsg, GeneralAnnouncements.ElderDragonBlazeAppeared);
        ...
        process1.AddDiscoverGroupBlock(QuestAnnounceType.None, EnemyGroupId.WaterfallGreatCavern + 1)
            ...
            .AddGeneralAnnounce(QuestGeneralAnnounceType.CommonMsg, GeneralAnnouncements.NewDragonKin);
        ...
        process1.AddProcessEndBlock(false)
            ...
            .AddGeneralAnnounce(QuestGeneralAnnounceType.CommonMsg, GeneralAnnouncements.DefatedTheEmeraldEye);
        ...
        process2.AddProcessEndBlock(false)
            ...
            .AddGeneralAnnounce(QuestGeneralAnnounceType.CommonMsg, GeneralAnnouncements.DefeatedTheRubyEye);
        ...
        process3.AddProcessEndBlock(false)
            ...
            .AddGeneralAnnounce(QuestGeneralAnnounceType.CommonMsg, GeneralAnnouncements.DefeatedTheLapisEye);
        ...
        foreach (var enemyGroupId in trashGroupIds)
        {
            ...
            if (enemyGroupId == timespawnEnemyGroupId)
            {
                ...
                process.AddProcessEndBlock(false)
                    ...
                    .AddGeneralAnnounce(QuestGeneralAnnounceType.CommonMsg, GeneralAnnouncements.DiscoverTimeExtEnemy);
            }
            else
            {
        ...
        processN.AddDiscoverGroupBlock(QuestAnnounceType.None, EnemyGroupId.TimeBonus)
            .AddEndContentsPurpose(Purpose.FindAndDefeatTimeBonus);
        processN.AddDestroyGroupBlock(QuestAnnounceType.None, EnemyGroupId.TimeBonus, false);
        processN.AddProcessEndBlock(false)
            .SetTimeAmount(300)
            .AddGeneralAnnounce(QuestGeneralAnnounceType.CommonMsg, GeneralAnnouncements.TimeBonus5min);
    }
}
