...
skillAugmentation.AddNode(13)
    .Location(6, 5)
    .BloodOrbCost(1100)
    .Unlocks(OrbGainParamType.JobPhysicalDefence, 10)
    .HasUnlockDependencies(7);
...
skillAugmentation.AddNode(98)
    .Location(7, 37)
    .BloodOrbCost(2700)
    .Unlocks(OrbGainParamType.JobStaminaMax, 35)
