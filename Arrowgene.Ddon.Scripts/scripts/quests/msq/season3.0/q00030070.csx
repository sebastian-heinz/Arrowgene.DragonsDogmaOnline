...
public class ScriptedQuest : IQuest
{
    ...
    protected override void InitializeEnemyGroups()
    {
        ...
        AddEnemies(EnemyGroupId.Encounter + 3, Stage.DacreimFortress0, 4, QuestEnemyPlacementType.Manual, new()
        {
            ...
            LibDdon.Enemy.CreateAuto(EnemyId.BlackGriffin0, 84, 8)
        ...
        AddEnemies(EnemyGroupId.Encounter + 5, Stage.DacreimFortress0, 1, QuestEnemyPlacementType.Manual, new()
        {
        });
    }
    ...
    protected override void InitializeBlocks()
    {
        ...
        // Handle spawning and erasing the adds
        ...
        process2.AddMyQstFlagsBlock(QuestAnnounceType.None)
            .AddMyQstCheckFlag(MyQstFlag.EndAdds);
        process2.AddSpawnGroupBlock(QuestAnnounceType.None, EnemyGroupId.Encounter + 5);
