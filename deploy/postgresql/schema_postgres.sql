...
(
    ...
    "job"             SMALLINT NOT NULL,
    "training_status" BYTEA     NOT NULL,
...
--     "character_id"      INTEGER NOT NULL,
--     "is_add_stat1"      SMALLINT NOT NULL,
--     "is_add_stat2"      SMALLINT NOT NULL,
...
(
    "bazaar_id"       SERIAL PRIMARY KEY NOT NULL,
    "character_id"    INTEGER                           NOT NULL,
    "sequence"        INTEGER                           NOT NULL,
    "item_id"         INTEGER                           NOT NULL,
    "num"             INTEGER                           NOT NULL,
    "price"           INTEGER                           NOT NULL,
    "exhibition_time" TIMESTAMP WITH TIME ZONE                          NOT NULL,
...
(
    "uniq_reward_id"       SERIAL PRIMARY KEY NOT NULL,
    "character_common_id"  INTEGER                           NOT NULL,
...
(
    ...
    "exp_mode"     SMALLINT  NOT NULL DEFAULT 1,
...
(
    "character_id"      INTEGER PRIMARY KEY NOT NULL,
    "last_stamp_time"   TIMESTAMP WITH TIME ZONE            NOT NULL,
