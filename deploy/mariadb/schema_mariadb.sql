/* Style hints:
   ...
   embed AUTO_INCREMENT in column definition
...
(
    "bazaar_id"       INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL,
    "character_id"    INTEGER                           NOT NULL,
...
(
    "uniq_reward_id"       INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL,
    "character_common_id"  INTEGER                           NOT NULL,
...
(
    "clan_id"               INTEGER PRIMARY KEY AUTO_INCREMENT,
...
(
    "record_id"           INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL,
    "character_id"        INTEGER                           NOT NULL,
    "quest_id"            INTEGER                           NOT NULL,
