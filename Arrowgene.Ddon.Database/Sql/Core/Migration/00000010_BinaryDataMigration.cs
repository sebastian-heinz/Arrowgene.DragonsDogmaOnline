...
namespace Arrowgene.Ddon.Database.Sql.Core.Migration
{
    public class BinaryDataMigration : IMigrationStrategy
    {
        ...
        public bool Migrate(IDatabase db, DbConnection conn)
        {
            ...
            S2CCharacterDecideCharacterIdRes pcap = EntitySerializer.Get<S2CCharacterDecideCharacterIdRes>().Read(data_Dump_13);
                ...
                while (reader.Read())
                {
                    ...
                    db.ExecuteNonQuery(conn, @"INSERT INTO ddon_binary_data(character_id, binary_data)
                            ...
                            action =>
                            {
                                ...
                                db.AddParameter(action, "binary_data", pcap.BinaryData);
                            });
                }
            });
        ...
        private static byte[] data_Dump_13 = new byte[] /* 2.0.2 */
{
