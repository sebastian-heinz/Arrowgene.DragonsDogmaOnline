...
(
    ...
    voice_pitch                 SMALLINT UNSIGNED   NOT NULL,
    ...
    sokutobu                    SMALLINT UNSIGNED   NOT NULL,
    hitai                       SMALLINT UNSIGNED   NOT NULL,
    mimi_jyouge                 SMALLINT UNSIGNED   NOT NULL,
    kannkaku                    SMALLINT UNSIGNED   NOT NULL,
    mabisasi_jyouge             SMALLINT UNSIGNED   NOT NULL,
    hanakuchi_jyouge            SMALLINT UNSIGNED   NOT NULL,
    ago_saki_haba               SMALLINT UNSIGNED   NOT NULL,
    ago_zengo                   SMALLINT UNSIGNED   NOT NULL,
    ago_saki_jyouge             SMALLINT UNSIGNED   NOT NULL,
    hitomi_ookisa               SMALLINT UNSIGNED   NOT NULL,
    me_ookisa                   SMALLINT UNSIGNED   NOT NULL,
    me_kaiten                   SMALLINT UNSIGNED   NOT NULL,
    mayu_kaiten                 SMALLINT UNSIGNED   NOT NULL,
    mimi_ookisa                 SMALLINT UNSIGNED   NOT NULL,
    mimi_muki                   SMALLINT UNSIGNED   NOT NULL,
    elf_mimi                    SMALLINT UNSIGNED   NOT NULL,
    miken_takasa                SMALLINT UNSIGNED   NOT NULL,
    miken_haba                  SMALLINT UNSIGNED   NOT NULL,
    hohobone_ryou               SMALLINT UNSIGNED   NOT NULL,
    hohobone_jyouge             SMALLINT UNSIGNED   NOT NULL,
    hohoniku                    SMALLINT UNSIGNED   NOT NULL,
    erahone_jyouge              SMALLINT UNSIGNED   NOT NULL,
    erahone_haba                SMALLINT UNSIGNED   NOT NULL,
    hana_jyouge                 SMALLINT UNSIGNED   NOT NULL,
    hana_haba                   SMALLINT UNSIGNED   NOT NULL,
    hana_takasa                 SMALLINT UNSIGNED   NOT NULL,
    hana_kakudo                 SMALLINT UNSIGNED   NOT NULL,
    kuchi_haba                  SMALLINT UNSIGNED   NOT NULL,
    kuchi_atsusa                SMALLINT UNSIGNED   NOT NULL,
    eyebrow_uv_offset_x         SMALLINT UNSIGNED   NOT NULL,
    eyebrow_uv_offset_y         SMALLINT UNSIGNED   NOT NULL,
    wrinkle                     SMALLINT UNSIGNED   NOT NULL,
    wrinkle_albedo_blend_rate   SMALLINT UNSIGNED   NOT NULL,
    wrinkle_detail_normal_power SMALLINT UNSIGNED   NOT NULL,
    muscle_albedo_blend_rate    SMALLINT UNSIGNED   NOT NULL,
    muscle_detail_normal_power  SMALLINT UNSIGNED   NOT NULL,
    height                      SMALLINT UNSIGNED   NOT NULL,
    head_size                   SMALLINT UNSIGNED   NOT NULL,
    neck_offset                 SMALLINT UNSIGNED   NOT NULL,
    neck_scale                  SMALLINT UNSIGNED   NOT NULL,
    upper_body_scale_x          SMALLINT UNSIGNED   NOT NULL,
    belly_size                  SMALLINT UNSIGNED   NOT NULL,
    teat_scale                  SMALLINT UNSIGNED   NOT NULL,
    tekubi_size                 SMALLINT UNSIGNED   NOT NULL,
    koshi_offset                SMALLINT UNSIGNED   NOT NULL,
    koshi_size                  SMALLINT UNSIGNED   NOT NULL,
    ankle_offset                SMALLINT UNSIGNED   NOT NULL,
    fat                         SMALLINT UNSIGNED   NOT NULL,
    muscle                      SMALLINT UNSIGNED   NOT NULL,
    motion_filter               SMALLINT UNSIGNED   NOT NULL,
