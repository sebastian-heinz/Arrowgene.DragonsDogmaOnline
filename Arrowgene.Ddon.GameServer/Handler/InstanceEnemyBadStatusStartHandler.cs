...
{
    public class InstanceEnemyBadStatusStartHandler : GameStructurePacketHandler<C2SInstanceEnemyBadStatusStart>
    {
        ...
        public override void Handle(GameClient client, StructurePacket<C2SInstanceEnemyBadStatusStart> packet)
        {
