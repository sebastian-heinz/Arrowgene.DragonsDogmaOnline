...
namespace Arrowgene.Ddon.GameServer.Handler
{
    public class SkillGetAcquirableSkillListHandler : StructurePacketHandler<GameClient, C2SSkillGetAcquirableSkillListReq>
    {
        ...
        public static readonly List<CDataSkillParam> AllSkills = new List<CDataSkillParam>() {
            ...
            // Spirit Lance
            new CDataSkillParam() {SkillNo = 1, Job = JobId.SpiritLancer},
            new CDataSkillParam() {SkillNo = 2, Job = JobId.SpiritLancer},
            new CDataSkillParam() {SkillNo = 3, Job = JobId.SpiritLancer},
            new CDataSkillParam() {SkillNo = 4, Job = JobId.SpiritLancer},
            new CDataSkillParam() {SkillNo = 5, Job = JobId.SpiritLancer},
            new CDataSkillParam() {SkillNo = 6, Job = JobId.SpiritLancer},
            new CDataSkillParam() {SkillNo = 7, Job = JobId.SpiritLancer},
            new CDataSkillParam() {SkillNo = 8, Job = JobId.SpiritLancer},
            new CDataSkillParam() {SkillNo = 9, Job = JobId.SpiritLancer},
            new CDataSkillParam() {SkillNo = 10, Job = JobId.SpiritLancer},
            new CDataSkillParam() {SkillNo = 107, Job = JobId.SpiritLancer},
            new CDataSkillParam() {SkillNo = 207, Job = JobId.SpiritLancer},
            new CDataSkillParam() {SkillNo = 101, Job = JobId.SpiritLancer},
            new CDataSkillParam() {SkillNo = 201, Job = JobId.SpiritLancer},
            new CDataSkillParam() {SkillNo = 104, Job = JobId.SpiritLancer},
            new CDataSkillParam() {SkillNo = 204, Job = JobId.SpiritLancer},
            new CDataSkillParam() {SkillNo = 108, Job = JobId.SpiritLancer},
            new CDataSkillParam() {SkillNo = 208, Job = JobId.SpiritLancer},
            // High Scepter
